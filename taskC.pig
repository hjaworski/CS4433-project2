...
-- taskC:
groupedc = GROUP MyPage BY nationality;
countsc = FOREACH groupedc GENERATE group, COUNT(MyPage);
STORE countsc into '/Users/kelseymoody/Desktop/DS4433/taskC.csv' USING PigStorage(',');